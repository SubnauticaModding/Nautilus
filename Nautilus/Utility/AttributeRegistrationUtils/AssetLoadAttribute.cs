...
/// The name of the argument corresponds an asset from the <see cref="AssetBundle"/> supplied at <see cref="RegistryEventUtils.ExecuteAssemblyAttributeRegistries"/>
