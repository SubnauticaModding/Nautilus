namespace SMLHelper.Options.Attributes
{
    ...
    /// <summary>
    /// Abstract base attribute used to signify the decorated public member should generate a <see cref="OptionItem"/>
    ...
    public abstract class ModOptionAttribute : Attribute
    {
        ...
        /// <summary>
        /// Signifies the decorated member should be represented in the mod's options menu as a <see cref="OptionItem"/>
