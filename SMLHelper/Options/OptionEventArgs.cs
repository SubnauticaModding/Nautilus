namespace SMLHelper.Options
{
    ...
    /// <summary>
    /// Interface for event arguments for a <see cref="Options.OptionItem"/>.
    /// </summary>
    ...
    {
        /// <summary>
        /// The typed Value of the <see cref="Options.ModOption"/> this event corresponds to.
        /// </summary>
        public T Value { get; }

        /// <summary>
        /// Instantiates a new <see cref="ConfigOptionEventArgs{T}"/> for handling an event from a <see cref="ModOption"/>.
        /// </summary>
