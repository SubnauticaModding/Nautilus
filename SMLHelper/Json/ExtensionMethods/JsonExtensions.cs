namespace SMLHelper.V2.Json.ExtensionMethods
{
    ...
    public static class JsonExtensions
    {
        ...
        /// <param name="createIfNotExist">Whether a new JSON file should be created with default values if
        /// it does not already exist.</param>
        /// <param name="jsonConverters">The <see cref="JsonConverter"/>s to be used for
        ...
        /// <summary>
        /// Saves the current fields and properties of the <paramref name="jsonObject"/> as JSON properties
        /// to the file on disk.
        /// </summary>
        /// <typeparam name="T">The type of the <paramref name="jsonObject"/>.</typeparam>
